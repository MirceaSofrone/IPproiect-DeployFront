...
import com.hpprediction.demo.userapp.repositories.RoleRepository;
...
public class RegistrationService {
    ...
    public MessageResponse registerUser(SignupRequest signUpRequest){
        ...
        String link = "http://" + HOST + "/api/auth/confirm?token=" + token;
        ...
        emailSender.send(Encoder.decrypt(user.getEmail()),
                ...
                EmailTemplateService.TEMPLATECONFIRM,
                model);
