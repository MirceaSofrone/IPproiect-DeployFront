...
//
//    @PostMapping("/create")
//    public ResponseEntity<?> storePhoto(@RequestBody HousePhotos photos) throws IOException {
//        if(housePhotosService.getPhotosFromHouseID(photos.getHouseID()).size() <5){
//            HousePhotos housePhoto = housePhotosService.store(photos.getData(),photos.getHouseID());
